<?php
	...
	class usuarioController{
		...
		public function Guardar(){
			...
			/*
			$usuario->__SET$idUsuario('idregdocente',		trim($_REQUEST['txtidusuario']));
			$usuario->__SET('iddocente',		trim($_REQUEST['txtusername']));
			$usuario->__SET('nombre',			trim($_REQUEST['txtnombreusuario']));
			$usuario->__SET('apellido',			trim($_REQUEST['txtpass']));
			$usuario->__SET('direccion',		trim($_REQUEST['rol']));
			*/
